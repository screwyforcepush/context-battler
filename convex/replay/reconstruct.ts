...
import crosswindMap from "../../maps/crosswind.json" with { type: "json" };
import faultlineMap from "../../maps/faultline.json" with { type: "json" };
import marketMazeMap from "../../maps/market-maze.json" with { type: "json" };
import referenceMap from "../../maps/reference.json" with { type: "json" };
import splitBasinMap from "../../maps/split-basin.json" with { type: "json" };
