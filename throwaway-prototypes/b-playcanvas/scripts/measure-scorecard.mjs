...
Measures a built Vite app from a gzip static server with Chrome DevTools
Protocol throttling. Run from throwaway-prototypes/b-playcanvas once the core
app exists.
...
async function launchChrome(opts) {
  ...
  const userDataDir = mkdtempSync(path.join(os.tmpdir(), "b-playcanvas-measure-"));
